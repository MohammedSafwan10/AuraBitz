...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    const routes = [
        ...
        { path: "/blocks/feature-showcases/04", priority: 0.7, changeFrequency: "monthly" as const },
        ...
        { path: "/blocks/pricing-tables/02", priority: 0.7, changeFrequency: "monthly" as const },
        { path: "/blocks/pricing-tables/03", priority: 0.7, changeFrequency: "monthly" as const },
