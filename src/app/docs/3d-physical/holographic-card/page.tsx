...
export function HolographicCard({
    ...
    const highlightOpacity = useTransform(
        mouseXSpring, [-0.5, -0.1, 0, 0.1, 0.5], [0.15, 0.4, 0.5, 0.4, 0.15]
    );
    ...
    return (
        <motion.div
            ...
            className={cn(
                ...
                "cursor-default group/card", className
            )}
        >
            <motion.div
            ...
            >
                <motion.div className="absolute w-[200%] h-[200%]" style={{
                    left: highlightX, top: highlightY, x: "-50%", y: "-50%",
                    opacity: highlightOpacity,
                    background: "radial-gradient(ellipse 35% 35% at 50% 50%, rgba(255,255,255,0.35) 0%, rgba(255,255,255,0.08) 40%, transparent 70%)",
                }} />
            </motion.div>
            ...
            <div className="relative z-20 h-full w-full" style={{ transform: "translateZ(25px)" }}>
                {children}
            </div>
        </motion.div>
    );
