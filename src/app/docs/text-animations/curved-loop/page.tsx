        ...
        <div className="max-w-3xl pb-20">
            <div className="relative mb-10">
                ...
                <div className="relative z-10">
                    ...
                    <h1 className="grad-text text-4xl md:text-5xl font-extrabold tracking-tighter mb-5">Curved Loop</h1>
                    <p className="text-white/50 text-lg leading-relaxed font-light max-w-2xl">Infinite circular marquee typographic systems.</p>
                </div>
            </div>
