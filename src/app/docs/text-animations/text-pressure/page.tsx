        ...
        <div className="max-w-3xl pb-20">
            <div className="relative mb-10">
                ...
                <div className="relative z-10">
                    ...
                    <h1 className="grad-text text-4xl md:text-5xl font-extrabold tracking-tighter mb-5">Text Pressure</h1>
                    <p className="text-white/50 text-lg leading-relaxed font-light max-w-2xl">Weight-responsive localized text scaling and manipulation.</p>
                </div>
            </div>
