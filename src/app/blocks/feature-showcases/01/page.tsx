...
export const metadata = {
    ...
    description: "A narrative feature block with editorial pacing, proof surfaces, and spring-driven transitions.",
};

export default function FeatureShowcase01Page() {
    return (
            ...
            <div className="relative mb-8 pl-2 max-w-3xl">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <span className="text-white/80 font-mono text-xs">Feature 01</span>
                    </div>
                    <h1 className="grad-text text-4xl md:text-5xl font-extrabold tracking-tighter mb-5">Feature Showcase 01</h1>
                    <p className="text-white/50 text-lg leading-relaxed font-light max-w-2xl">
                        A premium narrative block built for launch pages, product reveals, and high-trust technical storytelling.
                    </p>
                </div>
            </div>
                ...
                <div className="space-y-4">
                    <div className="group relative p-5 rounded-2xl border border-white/[0.05] bg-[#0a0a0a] overflow-hidden">
                        ...
                        <p className="text-sm text-white/50 font-light max-w-2xl leading-relaxed mb-4">
                            This feature block composes existing atomic primitives. Copy these first before importing the full showcase.
                        </p>
                        <div className="flex flex-wrap gap-2">
                            ...
                            <span className="text-xs font-mono text-white/70 bg-white/[0.05] border border-white/10 px-2 py-1 rounded">ScrambleReveal</span>
                    ...
                    <div className="group relative p-5 rounded-2xl border border-white/[0.05] bg-[#0a0a0a] overflow-hidden">
                        <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/[0.1] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                        <p className="text-xs text-white/40 mb-3 font-mono uppercase tracking-[0.1em]">2. Install Motion Dependencies</p>
                        <pre className="flex items-center justify-between font-mono text-[13px] text-emerald-400/90 bg-black/50 p-3 rounded-xl border border-white/[0.05] overflow-x-auto">
