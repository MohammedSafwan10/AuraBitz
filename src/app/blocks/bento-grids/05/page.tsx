...
import { Bento05 } from "@/components/blocks/bento-05";
import { CodePreview } from "@/components/site/code-preview";

const codeEndpoint = "/api/code?type=block&name=bento-05.tsx";

export const metadata: Metadata = {
    title: "Bento 05 - AuraBitz Blocks",
    description: "The Infinite Canvas Spatial layout.",
};

export default function Bento05Page() {
    return (
        <div className="w-full flex-1 flex flex-col pt-4 pb-20 max-w-7xl">
            ...
            <div className="mb-8 pl-2">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-white/80 font-mono text-xs">Bento 05</span>
                </div>
                <h1 className="text-2xl font-semibold tracking-tight">The Infinite Canvas (Spatial OS)</h1>
                <p className="text-white/40 text-sm mt-2 max-w-xl leading-relaxed font-light">
                    Concept D: A radical departure from the flat standard grid. Employs absolute positioning in a 3D isometric space
                    where interactive glass panes exist on multiple depths responding seamlessly to user physics mapping.
                </p>
            </div>

            {/* Preview + Code Integration */}
            <CodePreview codeEndpoint={codeEndpoint}>
                <div className="w-full bg-[#020202] overflow-hidden relative border-y border-white/[0.05]">
                    <Bento05 />
                </div>
            </CodePreview>
                ...
                <div className="space-y-4">
                    <div className="group relative p-5 rounded-2xl border border-white/[0.05] bg-[#0a0a0a] overflow-hidden">
                        ...
                        <div className="flex flex-wrap gap-2">
                            <span className="text-xs font-mono text-white/70 bg-white/[0.05] border border-white/10 px-2 py-1 rounded">ParallaxFloatingCard</span>
