export const metadata = {
    title: "Bento Grids - AuraBitz Blocks",
    description: "Premium bento grid layouts for feature showcases.",
};
        ...
        <div className="max-w-5xl pb-20">
            <div className="relative mb-10">
                ...
                <div className="relative z-10">
                    ...
                    <h1 className="grad-text text-4xl md:text-5xl font-extrabold tracking-tighter mb-5">Bento Grids</h1>
                    <p className="text-white/50 text-lg leading-relaxed font-light max-w-2xl">
                        Apple-style asymmetrical grid layouts built for interactive visual storytelling.
                    </p>
                </div>
            </div>
            <div className="p-8 border border-white/[0.05] bg-[#050505] rounded-2xl flex items-center justify-center min-h-[400px]">
                <p className="text-white/20 font-mono text-xs uppercase tracking-widest text-center">Bento grid blocks coming soon...</p>
            </div>
        </div>
    );
}
