...
const codeEndpoint = "/api/code?type=block&name=hero-02.tsx";

export default function Hero02Page() {
    return (
        <div className="w-full flex-1 flex flex-col pt-4 pb-20 max-w-7xl">
            ...
            <div className="mb-8 pl-2">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-white/80 font-mono text-xs">Hero 02</span>
                </div>
                <h1 className="text-2xl font-semibold tracking-tight">The Glass Singularity</h1>
                <p className="text-white/40 text-sm mt-2 max-w-xl leading-relaxed font-light">
                    The absolute pinnacle of frontend engineering. This architecture isolates a massive refractive Torus Knot inside a WebGL layer, capturing and distorting thousands of glowing instanced particles through genuine optical chromatic aberration. Built with React Three Fiber. Unreachable by standard DOM techniques.
                </p>
            </div>
